...
public class BNNormalChair extends BNChair {
	private static final VoxelShape SHAPE_BOTTOM = makeCuboidShape(3, 0, 3, 13, 16, 13);
	private static final VoxelShape SHAPE_TOP = makeCuboidShape(3, 0, 3, 13, 6, 13);
	private static final VoxelShape COLLIDER = makeCuboidShape(3, 0, 3, 13, 10, 13);
