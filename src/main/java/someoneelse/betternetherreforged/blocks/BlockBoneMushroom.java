...
public class BlockBoneMushroom extends BlockBaseNotFull {
	private static final VoxelShape SHAPE_NORTH = makeCuboidShape(1, 1, 8, 15, 15, 16);
	private static final VoxelShape SHAPE_SOUTH = makeCuboidShape(1, 1, 0, 15, 15, 8);
	private static final VoxelShape SHAPE_WEST = makeCuboidShape(8, 1, 1, 16, 15, 15);
	private static final VoxelShape SHAPE_EAST = makeCuboidShape(0, 1, 1, 8, 15, 15);
	private static final VoxelShape SHAPE_UP = makeCuboidShape(1, 0, 1, 15, 12, 15);
