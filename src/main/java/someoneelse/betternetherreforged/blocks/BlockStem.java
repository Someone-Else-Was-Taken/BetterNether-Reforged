...
public class BlockStem extends BlockBaseNotFull {
	...
	static {
		OUTLINES.put(Axis.X, makeCuboidShape(0, 5, 5, 16, 11, 11));
		OUTLINES.put(Axis.Y, makeCuboidShape(5, 0, 5, 11, 16, 11));
		OUTLINES.put(Axis.Z, makeCuboidShape(5, 5, 0, 11, 11, 16));
	}
}
