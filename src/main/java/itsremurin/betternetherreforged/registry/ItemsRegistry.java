...
import itsremurin.betternetherreforged.items.materials.BNItemMaterials;
...
import itsremurin.betternetherreforged.items.BNArmor;
import itsremurin.betternetherreforged.items.BNItemAxe;
import itsremurin.betternetherreforged.items.BNItemHoe;
import itsremurin.betternetherreforged.items.BNItemPickaxe;
import itsremurin.betternetherreforged.items.BNItemShovel;
import itsremurin.betternetherreforged.items.BNSword;
import itsremurin.betternetherreforged.items.ItemBlackApple;
import itsremurin.betternetherreforged.items.ItemBowlFood;
