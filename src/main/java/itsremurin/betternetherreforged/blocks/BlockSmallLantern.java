...
public class BlockSmallLantern extends BlockBaseNotFull {
	private static final VoxelShape SHAPE_NORTH = makeCuboidShape(5, 0, 8, 11, 16, 16);
	private static final VoxelShape SHAPE_SOUTH = makeCuboidShape(5, 0, 0, 11, 16, 8);
	private static final VoxelShape SHAPE_WEST = makeCuboidShape(8, 0, 5, 16, 16, 11);
	private static final VoxelShape SHAPE_EAST = makeCuboidShape(0, 0, 5, 8, 16, 11);
	private static final VoxelShape SHAPE_UP = makeCuboidShape(5, 0, 5, 11, 9, 11);
	private static final VoxelShape SHAPE_DOWN = makeCuboidShape(5, 3, 5, 11, 16, 11);
	...
	public boolean isValidPosition(BlockState state, IWorldReader world, BlockPos pos) {
		...
		return hasEnoughSolidSide(world, pos.offset(direction), direction.getOpposite());
	}
