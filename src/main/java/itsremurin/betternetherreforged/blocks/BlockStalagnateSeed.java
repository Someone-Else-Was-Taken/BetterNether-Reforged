...
public class BlockStalagnateSeed extends BlockBaseNotFull implements IGrowable {
	protected static final VoxelShape SHAPE_TOP = makeCuboidShape(4, 6, 4, 12, 16, 12);
	protected static final VoxelShape SHAPE_BOTTOM = makeCuboidShape(4, 0, 4, 12, 12, 12);
