...
import itsremurin.betternetherreforged.blocks.BlockPlantWall;
import itsremurin.betternetherreforged.blocks.BlockWillowBranch;
import itsremurin.betternetherreforged.blocks.BlockWillowLeaves;
...
import itsremurin.betternetherreforged.structures.StructureFuncScatter;
					...
					if (cx2 + cy2_out + cz2 < r2 && cx2 + cy2_in + cz2 > r2) {
						...
						if (world.getBlockState(POS).getMaterial().isReplaceable()) {
							if (random.nextBoolean()) {
								...
								BlocksHelper.setWithUpdate(world, POS.down(length - 1), vine.with(BlockWillowBranch.SHAPE, BlockWillowBranch.WillowBranchShape.END));
							}
